...
export default function ArkanoidPage({
  ...
  const DEBUG_COMPETITIONS: ICompetition[] = [
    {
      id: 1,
      seed: 123,
  ...
  const [page, setPage] = useState<'Competitions List' | 'Game'>(
    'Competitions List'
  );
  ...
  const SwitchWidget = () => {
    return (
      ...
      >
        ...
        <SwitchBtn title={arkanoidConfig.name} switchPage={Pages.Game}>
          <svg
            width="32"
            height="36"
            viewBox="0 0 32 36"
    ...
    >
      {page === 'Competitions List' && (
        <CompetitionWidget
          ...
          competitionList={DEBUG_COMPETITIONS}
          competitionsBlocks={[
            DEBUG_COMPETITIONS[0],
            DEBUG_COMPETITIONS[1],
            DEBUG_COMPETITIONS[2],
          ]}
        />
      )}
      {page === 'Game' && (
        <>
          <div className={'grid grid-cols-4 grid-rows-1 gap-4'}>
            ...
            <Competition
              startGame={startGame}
              competition={DEBUG_COMPETITIONS[0]}
            />
          </div>
